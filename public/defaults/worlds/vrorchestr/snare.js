...
this.intersectEventMethod = function() {
  ...
  if (quantize_toggle === true) {
    this.synth.triggerAttackRelease(['C6'], ['4n'], Tone.Time(Tone.now()).quantize(this.parent.quantize, this.parent.quantize_percentage), 0.3)
  } else {
    this.synth.triggerAttackRelease(['C6'], ['8n'], null, 0.3)
  }
}
